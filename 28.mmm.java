import java.io.*; //Java io package provides a set of input and output streams for reading and writing data
import java.lang.*;//java. util package and make them available to use within the current class or interface
import java.util.*;
    class mmm
    {
